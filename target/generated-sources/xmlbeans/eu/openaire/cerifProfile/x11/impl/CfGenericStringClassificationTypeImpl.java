 ...
 */
public class CfGenericStringClassificationTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements eu.openaire.cerifProfile.x11.CfGenericStringClassificationType
{
    ...
    public eu.openaire.cerifProfile.x11.CfGenericDateTimeSimpleType xgetStartDate()
    {
        synchronized (monitor())
        {
            ...
            target = (eu.openaire.cerifProfile.x11.CfGenericDateTimeSimpleType)get_store().find_attribute_user(STARTDATE$0);
            return target;
        }
    }
    ...
    public void xsetStartDate(eu.openaire.cerifProfile.x11.CfGenericDateTimeSimpleType startDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (eu.openaire.cerifProfile.x11.CfGenericDateTimeSimpleType)get_store().add_attribute_user(STARTDATE$0);
            }
    ...
    public eu.openaire.cerifProfile.x11.CfGenericDateTimeSimpleType xgetEndDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.x11.CfGenericDateTimeSimpleType target = null;
            target = (eu.openaire.cerifProfile.x11.CfGenericDateTimeSimpleType)get_store().find_attribute_user(ENDDATE$2);
            return target;
        }
    }
    ...
    public void xsetEndDate(eu.openaire.cerifProfile.x11.CfGenericDateTimeSimpleType endDate)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (eu.openaire.cerifProfile.x11.CfGenericDateTimeSimpleType)get_store().add_attribute_user(ENDDATE$2);
            }
            target.set(endDate);
        }
    }
