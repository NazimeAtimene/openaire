 ...
 */
public class CfGenericIdentifierTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfGenericIdentifierType
{
     ...
     */
    public eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfIdSimpleType xgetIssuerServiceId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfIdSimpleType target = null;
            target = (eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfIdSimpleType)get_store().find_attribute_user(ISSUERSERVICEID$0);
            return target;
        }
    }
     ...
     */
    public void xsetIssuerServiceId(eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfIdSimpleType issuerServiceId)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfIdSimpleType)get_store().add_attribute_user(ISSUERSERVICEID$0);
            }
