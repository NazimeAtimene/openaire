 ...
 */
public class CfLinkWithDisplayNameToPersonWithAffiliationsTypeImpl extends eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.impl.CfLinkWithDisplayNameBaseTypeImpl implements eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType
{
     ...
     */
    public eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation[] getAffiliationArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation[] result = new eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation[targetList.size()];
     ...
     */
    public eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation getAffiliationArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation target = null;
            target = (eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation)get_store().find_element_user(AFFILIATION$2, i);
            if (target == null)
            {
     ...
     */
    public void setAffiliationArray(eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation[] affiliationArray)
    {
        check_orphaned();
     ...
     */
    public void setAffiliationArray(int i, eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation affiliation)
    {
     ...
     */
    public eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation insertNewAffiliation(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation target = null;
            target = (eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation)get_store().insert_element_user(AFFILIATION$2, i);
            return target;
        }
    }
     ...
     */
    public eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation addNewAffiliation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation target = null;
            target = (eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation)get_store().add_element_user(AFFILIATION$2);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class AffiliationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements eu.openaire.cerifProfile.vocab.openAIREServiceCompatibility.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation
    {
        private static final long serialVersionUID = 1L;
