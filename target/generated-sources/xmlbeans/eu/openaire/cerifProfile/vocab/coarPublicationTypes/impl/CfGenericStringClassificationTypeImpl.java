 ...
 */
public class CfGenericStringClassificationTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericStringClassificationType
{
     ...
     */
    public eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericDateTimeSimpleType xgetStartDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericDateTimeSimpleType target = null;
            target = (eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericDateTimeSimpleType)get_store().find_attribute_user(STARTDATE$0);
            return target;
        }
    }
     ...
     */
    public void xsetStartDate(eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericDateTimeSimpleType startDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericDateTimeSimpleType)get_store().add_attribute_user(STARTDATE$0);
            }
     ...
     */
    public eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericDateTimeSimpleType xgetEndDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericDateTimeSimpleType target = null;
            target = (eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericDateTimeSimpleType)get_store().find_attribute_user(ENDDATE$2);
            return target;
        }
    }
     ...
     */
    public void xsetEndDate(eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericDateTimeSimpleType endDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.openaire.cerifProfile.vocab.coarPublicationTypes.CfGenericDateTimeSimpleType)get_store().add_attribute_user(ENDDATE$2);
            }
            target.set(endDate);
        }
    }
