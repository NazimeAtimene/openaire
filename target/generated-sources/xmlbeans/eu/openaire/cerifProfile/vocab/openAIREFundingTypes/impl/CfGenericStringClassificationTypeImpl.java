 ...
 */
public class CfGenericStringClassificationTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericStringClassificationType
{
     ...
     */
    public eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericDateTimeSimpleType xgetStartDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericDateTimeSimpleType target = null;
            target = (eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericDateTimeSimpleType)get_store().find_attribute_user(STARTDATE$0);
            return target;
        }
    }
     ...
     */
    public void xsetStartDate(eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericDateTimeSimpleType startDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericDateTimeSimpleType)get_store().add_attribute_user(STARTDATE$0);
            }
     ...
     */
    public eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericDateTimeSimpleType xgetEndDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericDateTimeSimpleType target = null;
            target = (eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericDateTimeSimpleType)get_store().find_attribute_user(ENDDATE$2);
            return target;
        }
    }
     ...
     */
    public void xsetEndDate(eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericDateTimeSimpleType endDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericDateTimeSimpleType)get_store().add_attribute_user(ENDDATE$2);
            }
            target.set(endDate);
        }
    }
