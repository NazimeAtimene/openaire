 ...
 */
public class CfMLangStringWithOptionalSourceTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfMLangStringWithOptionalSourceType
{
     ...
     */
    public eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfTransType.Enum getTrans()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfTransType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfTransType xgetTrans()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfTransType target = null;
            target = (eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfTransType)get_store().find_attribute_user(TRANS$2);
            if (target == null)
            {
                target = (eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfTransType)get_default_attribute_value(TRANS$2);
            }
            return target;
        }
    }
     ...
     */
    public void setTrans(eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfTransType.Enum trans)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTrans(eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfTransType trans)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfTransType)get_store().add_attribute_user(TRANS$2);
            }
            target.set(trans);
        }
    }
