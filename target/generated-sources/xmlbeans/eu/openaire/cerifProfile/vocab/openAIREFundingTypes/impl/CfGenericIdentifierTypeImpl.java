 ...
 */
public class CfGenericIdentifierTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfGenericIdentifierType
{
     ...
     */
    public eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfIdSimpleType xgetIssuerServiceId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfIdSimpleType target = null;
            target = (eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfIdSimpleType)get_store().find_attribute_user(ISSUERSERVICEID$0);
            return target;
        }
    }
     ...
     */
    public void xsetIssuerServiceId(eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfIdSimpleType issuerServiceId)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (eu.openaire.cerifProfile.vocab.openAIREFundingTypes.CfIdSimpleType)get_store().add_attribute_user(ISSUERSERVICEID$0);
            }
