 ...
 */
public class CfLinkWithDisplayNameToPersonWithAffiliationsTypeImpl extends org.purl.coar.resourceType.impl.CfLinkWithDisplayNameBaseTypeImpl implements org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType
{
     ...
     */
    public org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation[] getAffiliationArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation[] result = new org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation[targetList.size()];
     ...
     */
    public org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation getAffiliationArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation target = null;
            target = (org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation)get_store().find_element_user(AFFILIATION$2, i);
            if (target == null)
            {
     ...
     */
    public void setAffiliationArray(org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation[] affiliationArray)
    {
        check_orphaned();
     ...
     */
    public void setAffiliationArray(int i, org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation affiliation)
    {
     ...
     */
    public org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation insertNewAffiliation(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation target = null;
            target = (org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation)get_store().insert_element_user(AFFILIATION$2, i);
            return target;
        }
    }
     ...
     */
    public org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation addNewAffiliation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation target = null;
            target = (org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation)get_store().add_element_user(AFFILIATION$2);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class AffiliationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.purl.coar.resourceType.CfLinkWithDisplayNameToPersonWithAffiliationsType.Affiliation
    {
        private static final long serialVersionUID = 1L;
